...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'kf3eYQsdDT6T6NQhPRc4gmoLOIKLQvzFQfigiq4vnFFefuSzODoLehTNVvYLdT5LTA4')
...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://apiclima.aute.com.br", # domínio de produção
]
...
DATABASES = {
    'default': dj_database_url.config(
        default=os.environ.get('DATABASE_URL', 'postgres://user:password@localhost:5432/weather')
    )
}
